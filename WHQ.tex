...
\newcommand{\Opd}{\operatorname{Op_{\infty}}} % infinity category of inftyoperads
\newcommand{\Coop}{\operatorname{coOp_{\infty}}} % infinity category of cooperads
...
%%% Functors %%%
%%%%%%%%%%%%%%%%
\newcommand{\Free}{Free} % the free algebra functor
\newcommand{\cofree}{cofree} % the cofree coalgebra functor
\newcommand{\trivial}{Triv} % the trivial algebra/coalgebra functor
\newcommand{\oblv}{oblv} % the forgetful functor

\newcommand{\TAQ}{TAQ} % the TAQ functor
\newcommand{\Prim}{Prim} % the Prim functor
\newcommand{\Chev}{\widetilde{\operatorname{CE}}}
\newcommand{\Indec}{Indec} % the Indec functor
...
\DeclareMathOperator{\gr}{gr}   % graded objects
\DeclareMathOperator{\Fil}{Fil} % filtered objects 
